...
from Route_with_vehicles_and_congestion_genearted_with_AI import run_simulation_with_vehicles_and_no_device, run_simulation_with_vehicles_and_no_device_for_data_gathering, run_simulation_with_device_and_vehicles_for_data_gathering

filename = "device_results_for_training.json"
i = 0
while True:
    ...
    results = []
    while j < 9:
        results = run_simulation_with_device_and_vehicles_for_data_gathering(edges, j*50, j*3)
